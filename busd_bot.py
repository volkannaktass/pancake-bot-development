...
txt3 = "{} token will buy".format(token_amount)
print(txt3)
...
path = [tokenA, tokenToBuy] 

nonce = web3.eth.get_transaction_count(sender_address)
 
start = time.time()

pancakeswap2_txn = swapExactTokensForTokens(token_amount, 0, path, sender_address, (int(time()) +1000) ).buildTransaction({
    'from': sender_address,
